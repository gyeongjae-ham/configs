return {
    {
        ...
        config = function()
            ...
            vim.keymap.set('n', '<Space>fr', builtin.resume, { desc = '[F]inder [R]esume' })
            -- set a vim motion to <Space> + f + . to search for Recent Files
            vim.keymap.set('n', '<Space>f.', builtin.oldfiles, { desc = '[F]ind Recent Files ("." for repeat)' })
            -- set a vim motion to <Space> + f + b to search Open Buffers
            vim.keymap.set('n', '<Space>fb', builtin.buffers, { desc = '[F]ind Existing [B]uffers' })
        end
    },
    {
